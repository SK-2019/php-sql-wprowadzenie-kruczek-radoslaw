    ...
    <div class="container">
      ...
      <div class="main">
        <?php
          ...
          function table2($sql, $conn, $columnid, $column2, $column3, $dana, $dana2, $table){
            ...
            while($wiersz=$result->fetch_assoc()){
              echo("<tr>");
              echo("<td>".$wiersz[$columnid]."</td><td>".$wiersz[$dana2]."</td><td>".$wiersz[$dana]."</td><td>
          ...
          echo("<li>".$sql."</li>");
          table($sql, $conn, "id", "nazwisko", "tytul", 'id', 'tytul', 'autor_tytul');
        ?>
      </div>
    </div>
  </body>
